...
#Preview("通常") {
    RepoDetailsView.Content(repo: Repo.Mock.random(), isStarred: true, disableStarButton: false)
}

#Preview("説明と言語が空") {
    RepoDetailsView.Content(repo: Repo.Mock.sampleDataWithoutSomeInfo, isStarred: true, disableStarButton: false)
}
